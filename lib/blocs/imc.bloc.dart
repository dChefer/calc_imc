...
class ImcBloc {
  ...
  calculate() {
    ...
    if (imc < 18.6) {
      ...
      result = "Levemente assima do Peso (${imc.toStringAsPrecision(2)})";
    } else if (imc >= 29.9 && imc <= 34.9) {
      result = "Obesidade em Grau I (${imc.toStringAsPrecision(2)})";
    } else if (imc >= 34.9 && imc <= 39.9) {
      result = "Obesidade em Grau II (${imc.toStringAsPrecision(2)})";
    } else if (imc >= 40) {
      result = "Obesidade em Grau III (${imc.toStringAsPrecision(2)})";
    }
  }
}
